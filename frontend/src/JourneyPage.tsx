    ...
    <div className="journey-content">
      ...
      <div className="journey-passenger-card">
        <div className="journey-passenger-header">
          ...
          {isConfirmed && <div className="journey-confirmed-badge">Picked Up ✓</div>}
        </div>
...
// Main JourneyPage
const JourneyPage: React.FC<JourneyPageProps> = ({ canUseDriverMode, onDriverSignup }) => {
  const [mode, setMode] = useState<'user' | 'driver'>('user');

  // If user is not a driver, force the Journey page into Rider mode.
  useEffect(() => {
